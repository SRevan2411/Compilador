...
Nota: En este punto de desarrollo el programa aceptaba la entrada desde una cadena, en la fase de generación de código se implementa la lectura desde archivo.\
